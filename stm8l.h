...
#define TIM3_CR1 (*(__IO uint8_t*)0x5280)
#define TIM3_CR2 (*(__IO uint8_t*)0x5281)
#define TIM3_SMCR (*(__IO uint8_t*)0x5282)
#define TIM3_ETR (*(__IO uint8_t*)0x5283)
#define TIM3_DER (*(__IO uint8_t*)0x5284)
#define TIM3_IER (*(__IO uint8_t*)0x5285)
#define TIM3_SR1 (*(__IO uint8_t*)0x5286)
#define TIM3_SR2 (*(__IO uint8_t*)0x5287)
#define TIM3_EGR (*(__IO uint8_t*)0x5288)
#define TIM3_CCMR1 (*(__IO uint8_t*)0x5289)
#define TIM3_CCMR2 (*(__IO uint8_t*)0x528A)
#define TIM3_CCER1 (*(__IO uint8_t*)0x528B)
#define TIM3_CNTRH (*(__IO uint8_t*)0x528C)
#define TIM3_CNTRL (*(__IO uint8_t*)0x528D)
#define TIM3_PSCR (*(__IO uint8_t*)0x528E)
#define TIM3_ARRH (*(__IO uint8_t*)0x528F)
#define TIM3_ARRL (*(__IO uint8_t*)0x5290)
#define TIM3_CCR1H (*(__IO uint8_t*)0x5291)
#define TIM3_CCR1L (*(__IO uint8_t*)0x5292)
#define TIM3_CCR2H (*(__IO uint8_t*)0x5293)
